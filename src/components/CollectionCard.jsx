...
export default function CollectionCard({item}) {
    ...
    return (
    <div className='group relative w-full sm:w-[calc(50%-0.75rem)] lg:w-[calc(33.333%-1rem)] xl:w-[18vw] min-w-[280px] h-80 sm:h-96 bg-linear-to-br from-gray-800 to-gray-900 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl hover:shadow-red-500/30 transition-all duration-500 hover:scale-[1.02] border border-gray-700/50'>
